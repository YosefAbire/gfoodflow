      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">4-Week Harvest Forecast Models</h1>
            <DemoDataBadge />
          </div>
          <p className="text-xs text-slate-500 font-medium mt-0.5">
            Machine learning projections for weekly crop harvest yields across Gamo woredas.
          </p>
        </div>
